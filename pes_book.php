    ...
    <td><table width="94%" height="959" border="0" cellpadding="1" cellspacing="10" bordercolor="#FFFFFF">
      <tr>
        <td width="555" height="1084" rowspan="2" align="left" valign="top" bgcolor="#000000" class="foter"><p align="center">TICKETING</p>
          ...
          <form id="form1" name="form1" method="post" action="pes_book_money.php">
            <p>
              <label></label>
              Class : &nbsp;&nbsp;&nbsp;&nbsp;Platinum</p>
                    <p>Stand : East Stand                    
                    ...
                    <p><?php 
					    if(isset($_POST['Proceed']))
						{
					     ...
					     $t="$_POST[pes]";
						 $sq2=mysqli_query($con,"select seat_no from pes where seat_no NOT IN(select seat_no from booked_pes)");
						 $check="false";
						 ...
						 {
						  // $w_ins=mysqli_query($con,"insert into booked_gws (seat_no) values ('$_POST[gws]')");
						   $w_ins=mysqli_query($con,"insert into booked (seat_no) values ('$_POST[pes]')");
						 }
						 if($check=="false")
						 {
              ...
              <p>  
                ...
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22" title="BACK">
                  <param name="movie" value="button_pes1.swf" />
                  <param name="quality" value="high" />
                  <embed src="button_pes1.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
                </object>
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22" title="NEXT">
                  <param name="movie" value="button_pesnext.swf" />
                  <param name="quality" value="high" />
                  <embed src="button_pesnext.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
                </object>
              </p>
          </form>
