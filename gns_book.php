    ...
    <td><table width="94%" height="959" border="0" cellpadding="1" cellspacing="10" bordercolor="#FFFFFF">
      <tr>
        <td width="555" height="1084" rowspan="2" align="left" valign="top" bgcolor="#000000" class="foter"><p align="center">TICKETING</p>
          ...
          <form id="form1" name="form1" method="post" action="gns_book_money.php">
            <p>
              <label></label>
              Class : &nbsp;&nbsp;&nbsp;&nbsp;General </p>
                    <p>Stand : North Stand                    
                    ...
                    <p><?php 
					    if(isset($_POST['Proceed']))
						{
					     ...
					     $t="$_POST[gns]";
						 $sq2=mysqli_query($con,"select seat_no from gns where seat_no NOT IN(select seat_no from booked_gns)");
						 $check="false";
						 ...
						 {
						  // $w_ins=mysqli_query($con,"insert into booked_gws (seat_no) values ('$_POST[gws]')");
						   $w_ins=mysqli_query($con,"insert into booked (seat_no) values ('$_POST[gns]')");
						 }
						 if($check=="false")
						 {
              ...
              <p>  
                ...
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22" title="BACK">
                  <param name="movie" value="button_gns1.swf" />
                  <param name="quality" value="high" />
                  <embed src="button_gns1.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
                </object>
                </label>
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22" title="NEXT">
                  <param name="movie" value="button_gnsnext.swf" />
                  <param name="quality" value="high" />
                  <embed src="button_gnsnext.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
                </object>
              </p>
          </form>
