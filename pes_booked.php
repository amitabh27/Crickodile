									    ...
									    while($c_bal=mysqli_fetch_array($bal))
									    {
									     ...
									     if((int)$curr_bal>=1000)
									     {
								          ...
								          while($t1=mysqli_fetch_array($t))
								          {
								             ...
								             echo $t1["seat_no"]." ";
											 $t2=$t1["seat_no"];
											 $w_ins=mysqli_query($con,"insert into booked_pes (seat_no) values ('$t2')");
											 $s1=mysqli_query($con,"INSERT INTO user_info_pes (Name,Email_id,Stand,seat_no,Class) VALUES ('$_POST[Name]','$_POST[Email_id]','East Stand','$t2','Platinum')");
