    ...
    <td><table width="100%" height="959" border="0" cellpadding="1" cellspacing="10" bordercolor="#FFFFFF">
      <tr>
        <td height="1084" align="left" valign="top" bgcolor="#000000" class="foter"><p align="center"><img src="stadium/icc.jpg" alt="icc" width="128" height="72" /></p>
          ...
          <form id="form1" name="form1" method="post" action="nws_booked.php">
            <p>
              <label></label>
              </p>
									  ...
									  { 
									   ...
									   if($go=="true")
									   {
									    ...
									    while($c_bal=mysqli_fetch_array($bal))
									    {
									     ...
									     if((int)$curr_bal>=500)
									     {
									      $upd=mysqli_query($con,"update bank set balance=balance-500 where acc_no='$acc_check1'");
								          ...
								          while($t1=mysqli_fetch_array($t))
								          {
								             ...
								             echo $t1["seat_no"]." ";
											 $t2=$t1["seat_no"];
											 $w_ins=mysqli_query($con,"insert into booked_nws (seat_no) values ('$t2')");
											 $s1=mysqli_query($con,"INSERT INTO user_info_nws (Name,Email_id,Stand,seat_no,Class) VALUES ('$_POST[Name]','$_POST[Email_id]','North West Stand','$t2','General')");
											 ...
											 echo "STAND : NORTH WEST STAND <br>";
