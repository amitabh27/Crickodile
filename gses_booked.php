...
<body>
<table width="1199" height="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
  ...
  <tr bgcolor="#FF6600">
    <td width="1199" height="30"><div align="right" class="link">
    ...
    <td><table width="100%" height="959" border="0" cellpadding="1" cellspacing="10" bordercolor="#FFFFFF">
      <tr>
        <td height="1084" align="left" valign="top" bgcolor="#000000" class="foter"><p align="center"><img src="stadium/icc.jpg" alt="icc" width="128" height="72" /></p>
          ...
          <form id="form1" name="form1" method="post" action="gses_booked.php">
            <p>
              <label></label>
              </p>
									  ...
									  { 
									   ...
									   if($go=="true")
									   {
									    ...
									    while($c_bal=mysqli_fetch_array($bal))
									    {
									     ...
									     if((int)$curr_bal>=750)
									     {
									      $upd=mysqli_query($con,"update bank set balance=balance-750 where acc_no='$acc_check1'");
								          ...
								          while($t1=mysqli_fetch_array($t))
								          {
								             ...
								             echo $t1["seat_no"]." ";
											 $t2=$t1["seat_no"];
											 $w_ins=mysqli_query($con,"insert into booked_gses (seat_no) values ('$t2')");
											 $s1=mysqli_query($con,"INSERT INTO user_info_gses (Name,Email_id,Stand,seat_no,Class) VALUES ('$_POST[Name]','$_POST[Email_id]','South East Stand','$t2','General')");
											 ...
											 echo "STAND : SOUTH EAST STAND <br>";
