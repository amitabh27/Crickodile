    ...
    <td><table width="94%" height="959" border="0" cellpadding="1" cellspacing="10" bordercolor="#FFFFFF">
      <tr>
        <td width="555" height="1084" rowspan="2" align="left" valign="top" bgcolor="#000000" class="foter"><p align="center">TICKETING</p>
          ...
          <form id="form1" name="form1" method="post" action="pss_book_money.php">
            <p>
              <label></label>
              Class : &nbsp;&nbsp;&nbsp;&nbsp;Platinum</p>
                    <p>Stand : South Stand                    
                    ...
                    <p><?php 
					    if(isset($_POST['Proceed']))
						{
					     ...
					     $t="$_POST[pss]";
						 $sq2=mysqli_query($con,"select seat_no from pss where seat_no NOT IN(select seat_no from booked_pss)");
						 $check="false";
						 ...
						 {
						  // $w_ins=mysqli_query($con,"insert into booked_gws (seat_no) values ('$_POST[gws]')");
						   $w_ins=mysqli_query($con,"insert into booked (seat_no) values ('$_POST[pss]')");
						 }
						 if($check=="false")
						 {
              ...
              <p>  
                ...
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22" title="BACK">
                  <param name="movie" value="button_pss1.swf" />
                  <param name="quality" value="high" />
                  <embed src="button_pss1.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
                </object>
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22" title="NEXT">
                  <param name="movie" value="button_pssnext.swf" />
                  <param name="quality" value="high" />
                  <embed src="button_pssnext.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
                </object>
              </p>
          </form>
