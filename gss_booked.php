    ...
    <td><table width="100%" height="959" border="0" cellpadding="1" cellspacing="10" bordercolor="#FFFFFF">
      <tr>
        <td height="1084" align="left" valign="top" bgcolor="#000000" class="foter"><p align="center"><img src="stadium/icc.jpg" alt="icc" width="128" height="72" /></p>
          ...
          <form id="form1" name="form1" method="post" action="gss_booked.php">
            <p>
              <label></label>
              </p>
									    ...
									    while($c_bal=mysqli_fetch_array($bal))
									    {
									     ...
									     if((int)$curr_bal>=800)
									     {
								          ...
								          while($t1=mysqli_fetch_array($t))
								          {
								             ...
								             echo $t1["seat_no"]." ";
											 $t2=$t1["seat_no"];
											 $w_ins=mysqli_query($con,"insert into booked_gss (seat_no) values ('$t2')");
											 $s1=mysqli_query($con,"INSERT INTO user_info_gss (Name,Email_id,Stand,seat_no,Class) VALUES ('$_POST[Name]','$_POST[Email_id]','South Stand','$t2','General')");
